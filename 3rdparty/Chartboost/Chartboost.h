...
/*!
 ...
 @discussion Implement to be notified of when an "more applications" has been click for a given CBLocation.
...
/*!
 ...
 servers and cached locally for a given CBLocation.
 */
- (void)didLoadInPlay:(CBLocation)location;
...
/*!
 @deprecated This method has been deprecated and will be removed in a future version.
 */
- (void)didLoadInPlay __attribute__((deprecated("As of version 4.5, use didLoadInPlay:(CBLocation)location")));
