...
/** This event notifies the result of a connection attempt.
 ...
 @see onConnectionRetry:(SFSEvent *)evt
 @see onConnectionResume:(SFSEvent *)evt
 @see onConnectionLost:(SFSEvent *)evt
...
/** Dispatched when the external SmartFox configuration file has been loaded successfully.
 ...
 @see onConfigLoadFailure:(SFSEvent *)evt
...
.
 ...
 @see onConfigLoadSuccess:(SFSEvent *)evt
...
/** This event is dispatched in response to a JoinRoomRequest.
 ...
 @see onRoomJoinError:(SFSEvent *)evt
 @see JoinRoomRequest
...
/** This event is fired whenever a User enters one of the Rooms where the current User is joined.
 ...
 @see onUserExitRoom:(SFSEvent *)evt
 @see onRoomJoin:(SFSEvent *)evt
 @see JoinRoomRequest
...
/** This event is fired whenever a User leaves one of the Rooms where the current User is joined.
 ...
 @see onUserEnterRoom:(SFSEvent *)evt
 @see onRoomJoin:(SFSEvent *)evt
...
/** This event is fired in response to a SetRoomVariablesRequest
 ...
 @param roomId (NSNumber *) The id of the Room which the Extension is attached to (for Room Extensions only)
...
/** This event is fired at regular intervals when the LagMonitor is active
 ...
 @param lagValue (NSNumber) the average of the last measured lag values, expressed in milliseconds.
...
/** This event is fired in response to a SetUserPositionRequest.
 ...
 @param addedUsers (NSArray *) A list of User objects representing the users who entered the current user's Area of Interest. 
 @param removedUsers (NSArray *) A list of User objects representing the users who left the current user's Area of Interest.
 @param addedItems (NSArray *) A list of MMOItem objects which entered the current user's Area of Interest.
 @param removedItems (NSArray *) A list of MMOItem objects which left the current user's Area of Interest.
 @param room (SFSRoom*) The room where the event occurred
...
/** This event is fired in response to a server side SetMMOItemVariables.
 ...
 @param room (SFSRoom*) the room in which the event occurred
 @param mmoItem (MMOItem*) the item whose variables where changed
 @param changedVars (NSArray*) an array of variable names that were changed
...
/** This event is fired in response to a server side InitCrypto request.
 ...
 <b>NOTE:</b> It is necessary to send this request right after a successful connection event, before login.
